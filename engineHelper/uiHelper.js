...
function createButton(text, positionX, positionY, backgroundColor = 'green', textColor = 'white') {
...
function createImage(imagePath, positionX, positionY, width, height) {
...
function createInputBox(text, positionX, positionY, width, height, backgroundColor = 'black', textColor = 'white') 
{
...
function createTextBlock(text, width, height, positionX, positionY,  backgroundColor = 'black', textColor = 'white') 
{
